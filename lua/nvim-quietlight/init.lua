...
M.load = function()
	...
	local terminal_colors = {
		...
		colors3 = {
			terminal_color_0 = "#33374C",
			terminal_color_1 = "#25306D",
			terminal_color_2 = "#717AA8",
			terminal_color_3 = "#A0A8D3",
			terminal_color_4 = "#7C82A3",
			terminal_color_5 = "#ADB3D3",
			terminal_color_6 = "#5F647E",
			terminal_color_7 = "#686C6D",
			terminal_color_8 = "#33374C",
			terminal_color_9 = "#25306D",
			terminal_color_10 = "#717AA8",
			terminal_color_11 = "#A0A8D3",
			terminal_color_12 = "#7C82A3",
			terminal_color_13 = "#ADB3D3",
			terminal_color_14 = "#5F647E",
			terminal_color_15 = "#686C6D",
		},
	}
	local colorcaseList = {
		"colors1",
